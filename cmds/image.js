...
kenzki({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx2 I Am;kenzki_`)
        var txt = text.split(";")
        await m.react("⏳")
...
kenzki({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx3 I Am;kenzki_`)
        var txt = text.split(";")
        await m.react("⏳")
...
kenzki({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx4 I Am;kenzki_`)
        var txt = text.split(";")
        await m.react("⏳")
...
kenzki({
        ...
        try {
        if (!text) return await m.send(`_*provide three texts*_\n_example: ${prefix}gfx6 I Am;kenzki;Dev_`)
        var txt = text.split(";")
        if (txt.length < 3) return await m.send(`_*provide all three texts separated by semicolons*_\n_example: ${prefix}gfx6 I Am;kenzki;Dev_`)
        await m.react("⏳")
...
kenzki({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx7 I Am;kenzki_`)
        var txt = text.split(";")
        await m.react("⏳")
...
kenzki({
        ...
        try {
        if (!text) return await m.send(`_*provide two texts*_\n_example: ${prefix}gfx8 I Am;kenzki_`)
        var txt = text.split(";")
        await m.react("⏳")
...
kenzki({
  ...
  try {
        const response = await m.axios(`https://api.kenzki.live/api/lumina/search?query=${text}`)
